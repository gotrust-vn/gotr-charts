...
If everything is fine (passes [Technical Requirements](https://github.com/gotrust-vn/helm-charts/blob/main/CONTRIBUTING.md#technical-requirements), etc) then the PR should be [approved](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/approving-a-pull-request-with-required-reviews).
...
| ----------- | ---- |
| [helm-charts-maintainers](https://github.com/orgs/gotrust-vn/teams/helm-charts-maintainers) | Write |
| [helm-charts-admins](https://github.com/orgs/gotrust-vn/teams/helm-charts-admins) | Admin |

Chart maintainers are members of [@gotrust-vn/helm-charts-maintainers](https://github.com/orgs/gotrust-vn/teams/helm-charts-maintainers).
This allows them to manage issues, review PRs etc according to the rules in [CODEOWNERS](./.github/CODEOWNERS).
To request adding a user to [@gotrust-vn/helm-charts-maintainers](https://github.com/orgs/gotrust-vn/teams/helm-charts-maintainers), ask [@gotrust-vn/helm-charts-admins](https://github.com/orgs/gotrust-vn/teams/helm-charts-admins) in the corresponding issue or pull request.
